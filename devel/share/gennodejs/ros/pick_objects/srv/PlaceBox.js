...
class PlaceBoxRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlaceBoxRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlaceBoxRequest
    let len;
    let data = new PlaceBoxRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceBoxRequest(null);
...
class PlaceBoxResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlaceBoxResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlaceBoxResponse
    let len;
    let data = new PlaceBoxResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceBoxResponse(null);
...
module.exports = {
  Request: PlaceBoxRequest,
  Response: PlaceBoxResponse,
  md5sum() { return '4f4d1ddc81d0c0808876510a339bea29'; },
  datatype() { return 'pick_objects/PlaceBox'; }
};
